...
Why: Attackers often delete CloudTrail logs to cover their tracks. Production makes this impossible.

Advanced Filtering & Cost Optimization

Your setup: Logs EVERYTHING (management events)
...
Advanced event selectors: Log only DeleteBucket, PutBucketPolicy - not 
ListBucket
